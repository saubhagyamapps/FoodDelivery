...
import app.food.delivery.gps.TrackerService;
import app.food.delivery.R;
import app.food.delivery.adapter.PlaceArrayAdapter;
...
// Selecting the first object buffer.
    ...
    private void initialization() {
        ...
        mPlaceArrayAdapter = new PlaceArrayAdapter(this, R.layout.list_view, BOUNDS_MOUNTAIN_VIEW, null, R.drawable.ic_camera);
