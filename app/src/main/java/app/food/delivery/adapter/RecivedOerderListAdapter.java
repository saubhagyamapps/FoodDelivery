...
public class RecivedOerderListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecivedOerderListAdapter(Context mContex, BookClick bookClick) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.recivedorderlist, parent, false);
